namespace Shaderlens.Views.Menus
{
    public class ViewportMenuSource : IMenuSource
    {
        ...
        public void AddTo(IMenuBuilder builder)
        {
            ...
            builder.AddItem("Step", this.inputs.Step, this.resources.CreateStepIcon(), null, this.application.StepPipeline, state => state.IsVisible = this.application.IsFullyLoaded && this.application.IsPaused);
