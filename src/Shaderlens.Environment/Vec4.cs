namespace Shaderlens
{
    ...
    public class dvec4
    {
        ...
        public vec2 rr, rg, rb, ra, gr, gg, gb, ga, br, bg, bb, ba, ar, ag, ab, aa;
        public vec3 rrr, rrg, rrb, rra, rgr, rgg, rgb, rga, rbr, rbg, rbb, rba, rar, rag, rab, raa, grr, grg, grb, gra, ggr, ggg, ggb, gga, gbr, gbg, gbb, gba, gar, gag, gab, gaa, brr, brg, brb, bra, bgr, bgg, bgb, bga, bbr, bbg, bbb, bba, bar, bag, bab, baa, arr, arg, arb, ara, agr, agg, agb, aga, abr, abg, abb, aba, aar, aag, aab, aaa;
        public dvec4 rrrr, rrrg, rrrb, rrra, rrgr, rrgg, rrgb, rrga, rrbr, rrbg, rrbb, rrba, rrar, rrag, rrab, rraa, rgrr, rgrg, rgrb, rgra, rggr, rggg, rggb, rgga, rgbr, rgbg, rgbb, rgba, rgar, rgag, rgab, rgaa, rbrr, rbrg, rbrb, rbra, rbgr, rbgg, rbgb, rbga, rbbr, rbbg, rbbb, rbba, rbar, rbag, rbab, rbaa, rarr, rarg, rarb, rara, ragr, ragg, ragb, raga, rabr, rabg, rabb, raba, raar, raag, raab, raaa, grrr, grrg, grrb, grra, grgr, grgg, grgb, grga, grbr, grbg, grbb, grba, grar, grag, grab, graa, ggrr, ggrg, ggrb, ggra, gggr, gggg, gggb, ggga, ggbr, ggbg, ggbb, ggba, ggar, ggag, ggab, ggaa, gbrr, gbrg, gbrb, gbra, gbgr, gbgg, gbgb, gbga, gbbr, gbbg, gbbb, gbba, gbar, gbag, gbab, gbaa, garr, garg, garb, gara, gagr, gagg, gagb, gaga, gabr, gabg, gabb, gaba, gaar, gaag, gaab, gaaa, brrr, brrg, brrb, brra, brgr, brgg, brgb, brga, brbr, brbg, brbb, brba, brar, brag, brab, braa, bgrr, bgrg, bgrb, bgra, bggr, bggg, bggb, bgga, bgbr, bgbg, bgbb, bgba, bgar, bgag, bgab, bgaa, bbrr, bbrg, bbrb, bbra, bbgr, bbgg, bbgb, bbga, bbbr, bbbg, bbbb, bbba, bbar, bbag, bbab, bbaa, barr, barg, barb, bara, bagr, bagg, bagb, baga, babr, babg, babb, baba, baar, baag, baab, baaa, arrr, arrg, arrb, arra, argr, argg, argb, arga, arbr, arbg, arbb, arba, arar, arag, arab, araa, agrr, agrg, agrb, agra, aggr, aggg, aggb, agga, agbr, agbg, agbb, agba, agar, agag, agab, agaa, abrr, abrg, abrb, abra, abgr, abgg, abgb, abga, abbr, abbg, abbb, abba, abar, abag, abab, abaa, aarr, aarg, aarb, aara, aagr, aagg, aagb, aaga, aabr, aabg, aabb, aaba, aaar, aaag, aaab, aaaa;

        public static dvec4 operator +(dvec4 v1, dvec4 v2) { return default; }
        public static dvec4 operator +(dvec4 v1, double v2) { return default; }
        public static dvec4 operator +(double v1, dvec4 v2) { return default; }
        public static dvec4 operator -(dvec4 v) { return default; }
        public static dvec4 operator -(dvec4 v1, dvec4 v2) { return default; }
        public static dvec4 operator -(dvec4 v1, double v2) { return default; }
        public static dvec4 operator -(double v1, dvec4 v2) { return default; }
        public static dvec4 operator *(dvec4 v1, dvec4 v2) { return default; }
    ...
    public static partial class Environment
    {
        public static dvec4 dvec4(double xyzw) { return default; }
        public static dvec4 dvec4(double x, double y, double z, double w) { return default; }
        public static dvec4 dvec4(double x, double y, vec2 zw) { return default; }
        public static dvec4 dvec4(double x, vec2 yz, double w) { return default; }
        public static dvec4 dvec4(double x, vec3 yzw) { return default; }
        public static dvec4 dvec4(vec2 xy, double z, double w) { return default; }
        public static dvec4 dvec4(vec2 xy, vec2 zw) { return default; }
        public static dvec4 dvec4(vec3 xyz, double w) { return default; }

        public static dvec4 dvec4(vec4 xyzw) { return default; }
        public static dvec4 dvec4(dvec4 xyzw) { return default; }
        public static dvec4 dvec4(ivec4 xyzw) { return default; }
        public static dvec4 dvec4(uvec4 xyzw) { return default; }
        public static dvec4 dvec4(bvec4 xyzw) { return default; }
    }
}
