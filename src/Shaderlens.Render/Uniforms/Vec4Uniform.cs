namespace Shaderlens.Render.Uniforms
{
    ...
    public class Vec4Uniform : Uniform<Vector<double>>
    {
        ...
        public Vec4Uniform(IDispatcherThread renderThread, string displayName, Vector<double> minValue, Vector<double> maxValue, Vector<double> step, ISettingsValue<Vector<double>> settingsValue) :
    ...
    public class IVec4Uniform : Uniform<Vector<int>>
    {
        ...
        public IVec4Uniform(IDispatcherThread renderThread, string displayName, Vector<int> minValue, Vector<int> maxValue, Vector<int> step, ISettingsValue<Vector<int>> settingsValue) :
            base(renderThread, settingsValue)
        {
            this.displayName = displayName;
            this.minValue = minValue;
    ...
    public class UVec4Uniform : Uniform<Vector<uint>>
    {
        ...
        public UVec4Uniform(IDispatcherThread renderThread, string displayName, Vector<uint> minValue, Vector<uint> maxValue, Vector<uint> step, ISettingsValue<Vector<uint>> settingsValue) :
            base(renderThread, settingsValue)
        {
            this.displayName = displayName;
            this.minValue = minValue;
    ...
    public class BVec4Uniform : Uniform<Vector<bool>>
    {
        ...
        public BVec4Uniform(IDispatcherThread renderThread, string displayName, ISettingsValue<Vector<bool>> settingsValue) :
            base(renderThread, settingsValue)
        {
            this.displayName = displayName;
        }
