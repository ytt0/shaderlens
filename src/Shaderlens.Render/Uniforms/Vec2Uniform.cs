namespace Shaderlens.Render.Uniforms
{
    ...
    public class IVec2Uniform : Uniform<Vector<int>>
    {
        ...
        public IVec2Uniform(IDispatcherThread renderThread, string name, string displayName, Vector<int> minValue, Vector<int> maxValue, Vector<int> step, ISettingsValue<Vector<int>> settingsValue) :
            base(renderThread, name, settingsValue)
        {
            this.displayName = displayName;
            this.minValue = minValue;
    ...
    public class UVec2Uniform : Uniform<Vector<uint>>
    {
        ...
        public UVec2Uniform(IDispatcherThread renderThread, string name, string displayName, Vector<uint> minValue, Vector<uint> maxValue, Vector<uint> step, ISettingsValue<Vector<uint>> settingsValue) :
            base(renderThread, name, settingsValue)
        {
            this.displayName = displayName;
            this.minValue = minValue;
    ...
    public class BVec2Uniform : Uniform<Vector<bool>>
    {
        ...
        public BVec2Uniform(IDispatcherThread renderThread, string name, string displayName, ISettingsValue<Vector<bool>> settingsValue) :
            base(renderThread, name, settingsValue)
        {
            this.displayName = displayName;
        }
