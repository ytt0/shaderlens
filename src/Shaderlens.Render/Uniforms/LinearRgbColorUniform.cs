namespace Shaderlens.Render.Uniforms
{
    ...
    public class LinearRgbColorUniform : Uniform<Vector<double>>
    {
        ...
        public LinearRgbColorUniform(IDispatcherThread renderThread, string displayName, ISettingsValue<Vector<double>> settingsValue) :
        ...
        {
            uniformElementBuilder.AddColorElement(new Vec3Adapter(settingsValue), false, this.displayName);
        }
