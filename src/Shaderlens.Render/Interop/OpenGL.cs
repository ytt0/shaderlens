...
// Source: https://github.com/ForeverZer0/glfw-net
...
namespace OpenGL
{
    ...
    public static unsafe partial class Gl
    {
        ...
        public static string glGetString(int name)
        {
            ...
            return buffer != IntPtr.Zero ? PtrToStringUtf8(buffer) : null;
        }
        ...
        /// </summary>
        /// <param name="textures">Specifies an array of textures to be deleted.</param>
        public static void glDeleteTextures([AllowNull] uint[] textures)
        {
            if (textures is null)
                return;
        ...
        /// </summary>
        /// <param name="buffers">Specifies an array of framebuffer objects to be deleted.</param>
        public static void glDeleteFramebuffers([AllowNull] uint[] buffers)
        {
            if (buffers is null)
                return;
        ...
        /// </summary>
        /// <param name="buffers">Specifies an array of renderbuffer objects to be deleted.</param>
        public static void glDeleteRenderbuffers([AllowNull] uint[] buffers)
        {
            if (buffers is null)
                return;
            fixed (uint* ids = &buffers[0])
        ...
        /// </summary>
        /// <param name="buffers">Specifies an array of buffer objects to be deleted.</param>
        public static void glDeleteBuffers([AllowNull] uint[] buffers)
        {
            if (buffers is null)
                return;
            fixed (uint* ids = &buffers[0])
        ...
        public static void glDeleteVertexArrays([AllowNull] uint[] arrays)
        {
            if (arrays is null)
                return;
            fixed (uint* names = &arrays[0])
		...
		private static void Import(GetProcAddressHandler loader)
        {
