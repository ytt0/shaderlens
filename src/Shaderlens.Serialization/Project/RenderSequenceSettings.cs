namespace Shaderlens.Serialization.Project
{
    ...
    {
        public static readonly RenderSequenceSettings Default = new RenderSequenceSettings(null, 0, 25, 100, 0, new RenderSize(800, 600), false, false, false);
        ...
        public RenderSequenceSettings(string? targetPath, int bufferIndex, int frameRate, int frameCount, int startFrame, RenderSize renderSize, bool prerender, bool overridePath, bool relativeIndex)
        {
    ...
    public class RenderSequenceSettingsSerializer : IJsonSerializer<RenderSequenceSettings>
    {
        ...
        public RenderSequenceSettings Deserialize(JsonNode? source)
        {
            ...
            return new RenderSequenceSettings(targetPath, bufferIndex, frameRate, frameCount, startFrame, size, prerender, false, relativeIndex);
        }
